...
HD_PWD='E:/Arm/item/robei/ccd_adc/ccd_adc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ccd_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ccd_top.tcl -notrace
