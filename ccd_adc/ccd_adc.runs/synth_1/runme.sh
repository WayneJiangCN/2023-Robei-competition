...
HD_PWD='E:/Arm/item/robei/ccd_adc/ccd_adc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ccd_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ccd_top.tcl
