...
HD_PWD='E:/Arm/item/robei/sensor/sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor_top.tcl
