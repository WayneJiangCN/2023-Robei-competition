...
HD_PWD='E:/Arm/item/robei/sensor/sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensor_top.tcl -notrace
