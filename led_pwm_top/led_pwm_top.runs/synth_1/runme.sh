...
HD_PWD='E:/Arm/item/robei/item/led_pwm_top/led_pwm_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_pwm_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_pwm_top.tcl
