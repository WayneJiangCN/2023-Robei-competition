...
HD_PWD='E:/Arm/item/robei/item/led_pwm_top/led_pwm_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_pwm_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_pwm_top.tcl -notrace
