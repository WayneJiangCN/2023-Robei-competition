...
HD_PWD='E:/Arm/item/robei/item/step_top/step_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log step_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source step_top.tcl
