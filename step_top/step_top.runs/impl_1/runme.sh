...
HD_PWD='E:/Arm/item/robei/item/step_top/step_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log step_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source step_top.tcl -notrace
